          ...
          <div className="mb-4">
            ...
            <p className="text-gray-600">
              {filteredBuffalos.length === buffalosMock.length
                ? `Lista completa do rebanho com ${buffalosMock.length} búfalo${
                    buffalosMock.length !== 1 ? "s" : ""
                  }(as) ativos.`
                : `Mostrando ${filteredBuffalos.length} de ${
                    buffalosMock.length
                  } búfalo${buffalosMock.length !== 1 ? "s" : ""}(as) ativos.`}
