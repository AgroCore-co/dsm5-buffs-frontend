          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-4 rounded-lg shadow border border-[#e0e0e0]">
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-xs font-medium text-[var(--color-primary-dark)]">Média 12m</span>
              </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow border border-[#e0e0e0]">
              <div className="flex items-center justify-between mb-1">
                <h2 className="text-sm font-semibold text-[var(--color-text-secondary)]">Inseminações</h2>
                <span className="text-xs font-medium text-[var(--color-primary-dark)]">{viewMode === "monthly" ? "Mês corrente" : "Ano atual"}</span>
              </div>
              <p className="text-4xl font-extrabold tracking-tight text-[var(--color-text-dark)]">{viewMode === "monthly" ? 30 : 400}</p>
              <p className="text-xs text-[var(--color-text-tertiary)] mt-1">Procedimentos realizados</p>
            </div>

            <div className="bg-white p-4 rounded-lg shadow border border-[#e0e0e0]">
              <div className="flex items-center justify-between mb-1">
                <h2 className="text-sm font-semibold text-[var(--color-text-secondary)]">Prenhezes</h2>
                <span className="text-xs font-medium text-[var(--color-primary-dark)]">{viewMode === "monthly" ? "Mês corrente" : "Ano atual"}</span>
              </div>
              <p className="text-4xl font-extrabold tracking-tight text-[var(--color-text-dark)]">{viewMode === "monthly" ? 24 : 330}</p>
              <p className="text-xs text-[var(--color-text-tertiary)] mt-1">Confirmações positivas</p>
            </div>
          </div>
