...
export default function DeleteIndustriaModal({ isOpen, onClose, onConfirm, loading, error, industria }) {
  ...
  return (
    <div className="fixed inset-0 z-[1013] flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-md relative flex flex-col gap-4 border border-[#e0e0e0]">
        ...
        <h2 className="text-xl font-bold text-gray-800 mb-2">Excluir Indústria</h2>
        <p className="text-gray-700">Tem certeza que deseja excluir a indústria <span className="font-bold">{industria?.nome}</span>? Esta ação não pode ser desfeita.</p>
