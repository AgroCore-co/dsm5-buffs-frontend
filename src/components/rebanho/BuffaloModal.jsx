...
export default function BuffaloModal({
  ...
  useEffect(() => {
    console.log(
      `🔄 useEffect zootécnicos executado - activeTab: ${activeTab}, buffalo.id_bufalo: ${buffalo?.id_bufalo}`
    );
    ...
    const fetchZootecnicos = async () => {
      try {
        ...
        console.log(
          `🔍 Buscando dados zootécnicos para búfalo ID: ${buffalo.id_bufalo}`
        );
  ...
  useEffect(() => {
    console.log(
      `🔄 useEffect sanitários executado - activeTab: ${activeTab}, buffalo.id_bufalo: ${buffalo?.id_bufalo}`
    );
    ...
    const fetchSanitarios = async () => {
      try {
        ...
        console.log(
          `🔍 Buscando dados sanitários para búfalo ID: ${buffalo.id_bufalo}`
        );
                  ...
                  dadosZootecnicos.length === 0 && (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500">
                        Não há dados zootécnicos registrados para este búfalo.
                      </p>
                    </div>
                  )}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="border-t pt-4">
                        <p className="text-sm text-gray-500 text-center">
                          Total de {dadosZootecnicos.length} registro
                          {dadosZootecnicos.length !== 1 ? "s" : ""} encontrado
                          {dadosZootecnicos.length !== 1 ? "s" : ""}
                        </p>
                      </div>
                    </div>
                  )}
              ...
              <div className="rounded-2xl border border-gray-200 bg-white p-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Histórico de aplicações e tratamentos sanitários de{" "}
                      {bufaloData.nome}
                    </p>
                  </div>
                </div>
                ...
                {!carregandoSanitarios &&
                  ...
                  dadosSanitarios.length === 0 && (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500">
                        Não há dados sanitários registrados para este búfalo.
                      </p>
                    </div>
                  )}
                ...
                {!carregandoSanitarios &&
                  ...
                  dadosSanitarios.length > 0 && (
                    <div className="space-y-4">
                              ...
                              <div className="text-right">
                                <span
                                  className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                                    registro.medicacao?.tipo_tratamento ===
                                    "Vacinação"
                      ...
                      <div className="border-t pt-4">
                        <p className="text-sm text-gray-500 text-center">
                          Total de {dadosSanitarios.length} registro
                          {dadosSanitarios.length !== 1 ? "s" : ""} encontrado
                          {dadosSanitarios.length !== 1 ? "s" : ""}
                        </p>
                      </div>
                    </div>
                  )}
