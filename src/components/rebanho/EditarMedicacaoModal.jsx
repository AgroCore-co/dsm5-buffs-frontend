...
export default function EditarMedicacaoModal({ open, onClose, onSubmit, initialData }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErro(err.message || "Erro ao atualizar medicação.");
    } finally {
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {sucesso && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-sm text-green-700">
              ...
              <p>Medicação atualizada com sucesso!</p>
            </div>
          )}
