  ...
  const handleEnderecoSubmit = async (e) => {
    ...
    for (const campo of enderecoCamposObrigatorios) {
      ...
      if (!valor || !String(valor).trim()) {
        setError(`Campo '${campo}' do endereço é obrigatório e não pode estar vazio.`)
        return
      }
    }
    ...
    try {
      ...
      const payloadEndereco = {
        ...
        ponto_referencia: enderecoData.ponto_referencia ? String(enderecoData.ponto_referencia).trim() : "",
      }

      const requiredFields = ["pais", "estado", "cidade", "bairro", "rua", "cep"]
      for (const field of requiredFields) {
        if (!payloadEndereco[field]) {
          setError(`Erro na validação: Campo '${field}' está vazio após processamento.`)
          return
        }
      }
        ...
        <div className="flex justify-between items-center p-6 border-b border-gray-200">
          <div>
            ...
            <div className="flex items-center gap-2 mt-2">
              <div className={`flex items-center gap-2 ${currentStep >= 1 ? "text-amber-600" : "text-gray-400"}`}>
                <div
                  className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${currentStep >= 1 ? "bg-amber-600 text-white" : "bg-gray-300 text-gray-600"}`}
                >
                  1
                </div>
              ...
              <div className={`flex items-center gap-2 ${currentStep >= 2 ? "text-amber-600" : "text-gray-400"}`}>
                <div
                  className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${currentStep >= 2 ? "bg-amber-600 text-white" : "bg-gray-300 text-gray-600"}`}
                >
                  2
                </div>
          ...
          <form onSubmit={handleEnderecoSubmit} className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Brasil"
                    />
                    {!enderecoData.pais?.trim() && <p className="text-red-500 text-xs mt-1">Campo obrigatório</p>}
                  </div>
                  ...
                  <div>
                    ...
                    />
                    {!enderecoData.estado?.trim() && <p className="text-red-500 text-xs mt-1">Campo obrigatório</p>}
                  </div>
                  ...
                  <div>
                    ...
                    />
                    {!enderecoData.cidade?.trim() && <p className="text-red-500 text-xs mt-1">Campo obrigatório</p>}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Centro"
                    />
                    {!enderecoData.bairro?.trim() && <p className="text-red-500 text-xs mt-1">Campo obrigatório</p>}
                  </div>
                  ...
                  <div>
                    ...
                    />
                    {!enderecoData.rua?.trim() && <p className="text-red-500 text-xs mt-1">Campo obrigatório</p>}
                  </div>
                  ...
                  <div>
                    ...
                    />
                    {!enderecoData.cep?.trim() && <p className="text-red-500 text-xs mt-1">Campo obrigatório</p>}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleEnderecoChange("ponto_referencia", e.target.value)}
                      disabled={isLoading}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-400 disabled:bg-gray-100 disabled:opacity-50"
            ...
            <div className="flex justify-end gap-3 mt-6 pt-6 border-t border-gray-200">
              ...
              >
                ...
                {isLoading ? "Criando Endereço..." : "Próximo: Dados da Propriedade"}
              </button>
            </div>
          </form>
        )}
          ...
          <form onSubmit={handlePropriedadeSubmit} className="p-6">
            <div className="space-y-6">
              ...
              {createdAddress && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <div className="text-green-800 font-medium mb-2">✅ Endereço criado com sucesso!</div>
                  <div className="text-green-700 text-sm">
                    {createdAddress.rua}, {createdAddress.numero && `${createdAddress.numero}, `}
                    {createdAddress.bairro}, {createdAddress.cidade} - {createdAddress.estado}, {createdAddress.cep}
                  </div>
                </div>
              )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      onChange={(e) => handlePropriedadeChange("nome", e.target.value)}
                      disabled={isLoading}
                      required
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-400 disabled:bg-gray-100 disabled:opacity-50"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handlePropriedadeChange("cnpj", e.target.value)}
                      disabled={isLoading}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-400 disabled:bg-gray-100 disabled:opacity-50"
                  ...
                  {/* Tipo de Manejo */}
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Tipo de Manejo *</label>
                    <select
                      value={propriedadeData.tipo_manejo}
                      onChange={(e) => handlePropriedadeChange("tipo_manejo", e.target.value)}
                      disabled={isLoading}
                      required
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-400 disabled:bg-gray-100 disabled:opacity-50"
                    >
                  ...
                  <div className="md:col-span-2">
                    <label className="flex items-center space-x-3">
                      <input
                        ...
                        onChange={(e) => handlePropriedadeChange("p_abcb", e.target.checked)}
                        disabled={isLoading}
                        className="w-4 h-4 text-amber-600 border-gray-300 rounded focus:ring-amber-500 disabled:opacity-50"
                      />
                      <div>
                        <span className="text-sm font-medium text-gray-700">Propriedade ABCB</span>
                        <p className="text-xs text-gray-500">Marque se a propriedade está registrada na ABCB</p>
                      </div>
                    </label>
                  </div>
                </div>
            ...
            <div className="flex justify-between mt-6 pt-6 border-t border-gray-200">
              ...
              <div className="flex gap-3">
                ...
                <button
                  type="submit"
                  disabled={isLoading || !propriedadeData.nome?.trim() || !propriedadeData.tipo_manejo}
                  className="px-4 py-2 bg-[#FFCF78] text-gray-800 rounded-lg hover:bg-[#F2B84D] transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                >
                  {isLoading && (
                    <div className="w-4 h-4 border-2 border-gray-800 border-t-transparent rounded-full animate-spin"></div>
